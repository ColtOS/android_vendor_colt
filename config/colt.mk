...
LINEAGE_VERSION := ColtOS_Mojito-N-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date -u +%Y%m%d)-$(CM_BUILD)-v$(COS_VERSION)
LINEAGE_DISPLAY_VERSION := ColtOS_Mojito-N-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date -u +%Y%m%d)-v$(COS_VERSION)
